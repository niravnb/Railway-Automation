...
void init_lcd( void )
{
  ...
  lcd_gotoxy(0, 0);
  lcd_clear();	
  lcd_putstring(0,"  BE- E & C    ");
  lcd_putstring(1,"  BIT          ");
 delay(1000*1000);
  lcd_putstring(0,"  URMIL PATEL  ");
  lcd_putstring(1," 100050111007  ");
   delay(1000*1000);
  lcd_putstring(0," NIRAV BHAVSAR ");
  lcd_putstring(1," 100050111015  ");
   delay(1000*1000);
  lcd_putstring(0,"  SAGAR SHAH   ");
  lcd_putstring(1," 100050111025  ");
   delay(1000*1000);
  lcd_putstring(0,"  DEEP PATEL   ");
  lcd_putstring(1," 100050111039  ");
  delay(1000*1000);
  delay(1000*1000);
  lcd_putstring(0,"  WELCOME TEAM ");
  lcd_putstring(1,"RAIL AUTO MONIT");
   delay(1000*1000);
  delay(1000*1000);
}
